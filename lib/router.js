...
// xbdeals
router.get('/xbdeals/:tid/:cid', require('./routes/zzzzzzz/xbdeals/xbdeals'));
// eshop-switch
router.get('/eshopswitch', require('./routes/zzzzzzz/eshopswitch/index'));
// pianku
router.get('/pianku', require('./routes/zzzzzzz/pianku/mv'));
// eshop-sale-hk
router.get('/eshopsalehk', require('./routes/zzzzzzz/eshopsalehk/index'));
// chinadsl
router.get('/chinadsl', require('./routes/zzzzzzz/chinadsl/index'));
// portableappz
router.get('/pappz', require('./routes/zzzzzzz/pappz/index'));
// a9vg-switch-xbox
router.get('/a9vgsx/:mid', require('./routes/zzzzzzz/a9vgsx/forum'));
// runningcheese
router.get('/runningcheese', require('./routes/zzzzzzz/runningcheese/index'));
// xboxfan
router.get('/xboxfan/discounts/:tid', require('./routes/zzzzzzz/xboxfan/discounts'));
router.get('/xboxfan/rank', require('./routes/zzzzzzz/xboxfan/rank'));
router.get('/xboxfan/feed', require('./routes/zzzzzzz/xboxfan/feed'));
router.get('/xboxfan/news', require('./routes/zzzzzzz/xboxfan/news'));
// v2rayssr
router.get('/v2rayssr', require('./routes/zzzzzzz/v2rayssr/index'));
// tachyon
router.get('/tachyon', require('./routes/zzzzzzz/tachyon/index'));
// lianjia
router.get('/lianjia/:aid', require('./routes/zzzzzzz/lianjia/index'));
// kds
router.get('/kds', require('./routes/zzzzzzz/kds/index'));
// hupukog
router.get('/hupukog', require('./routes/zzzzzzz/hupukog/index'));
// bing-quiz
router.get('/bingquiz', require('./routes/zzzzzzz/bingquiz/index'));
// shyoujia
router.get('/shyoujia', require('./routes/zzzzzzz/shyoujia/index'));
// mobaxterm
router.get('/mobaxterm', require('./routes/zzzzzzz/mobaxterm/index'));
// proxmox
router.get('/proxmox', require('./routes/zzzzzzz/proxmox/index'));
// clash-premium
router.get('/clashp', require('./routes/zzzzzzz/clashp/index'));
// mpyit
router.get('/mpyit', require('./routes/zzzzzzz/mpyit/index'));
// apple-service
router.get('/applesrv', require('./routes/zzzzzzz/applesrv/index'));
// github-trending
router.get('/github/:tid', require('./routes/zzzzzzz/github/index'));
// gxnas
router.get('/gxnas', require('./routes/zzzzzzz/gxnas/index'));
// v2ray-agent
router.get('/v2rayagent', require('./routes/zzzzzzz/v2rayagent/index'));
// bulianglin
router.get('/bulianglin', require('./routes/zzzzzzz/bulianglin/index'));
// kejiwanjia
router.get('/kejiwanjia', require('./routes/zzzzzzz/kejiwanjia/index'));
// acwifimod
router.get('/acwifimod', require('./routes/zzzzzzz/acwifimod/index'));
// u9a9-madou
router.get('/u9a9md', require('./routes/zzzzzzz/u9a9md/index'));
// zhibo8-tianxiazuqiu
router.get('/zhibo8txzq', require('./routes/zzzzzzz/zhibo8txzq/index'));
// nintendo-hk-topics
router.get('/nintendohk', require('./routes/zzzzzzz/nintendohk/index'));
// steam-specials
router.get('/steamsp', require('./routes/zzzzzzz/steamsp/index'));
// dekudeals-hottest
router.get('/dekudealshot', require('./routes/zzzzzzz/dekudealshot/index'));
// autohome-tayron
router.get('/autohometayron', require('./routes/zzzzzzz/autohometayron/index'));

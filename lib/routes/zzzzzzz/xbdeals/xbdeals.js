        ...
        item:
            ...
            list
                .map((index, item) => {
                    item = $(item);
                    return {
                        title: `${item.find('.game-collection-item-details-title').text()} [${item.find('.game-collection-item-discount').text()}]`,
                        description: `
                            ...
                            ${item.find('span[class="game-collection-item-price "]').text()}<br>
